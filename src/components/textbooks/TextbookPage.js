...
//     render() {
//         let count_for_key = 0;
//         const { textbook_summary, textbook_title,textbook_subtitle, step_description_items,toast_step_items } = this.props;
...
//             count_for_key += 1
//             const image_src = (item.step_items && item.step_items[0].images && item.step_items[0].images.length>0 && item.step_items[0].images[0].src)? (URL+"/uploads/textbooks/"+item.step_items[0].images[0].src) : null
//             return(
